...
function displayPics(){
  ...
  // rando was declared inside a block of code and when changed to let it would have been pushed off the stack when it left the scope of the displayPics function.
  console.log(viewed);
